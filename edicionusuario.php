						 ...
						 <tr> 
						   ...
						   <td> 
						    Usuario:
                             ...
                             <input  id="usuario" type="text" class="form-control" name="usuario" value="<?php echo $tra["usuario"] ?>" placeholder="Usuario">         
								 </td> 
...
?> 
	   ...
	   <?php if ($tra["idcargo1"] == "0") { 
	  ?>
	<select name = "cargo1" class="form-control" id="cargo1">
...
?> 
	   ...
	   <?php if ($tra["idcargo2"] == "0") { 
	  ?>
	<select name = "cargo2" class="form-control" id="cargo2">
	<option selected value = "0"> (Sin Especificar)</option>
	<?php
...
?> 
	  ...
	  ?>
	<select name = "cargo3" class="form-control" id="cargo3">
	<option selected value = "0"> (Sin Especificar)</option>
	<?php
		while ($reg11 = mysqli_fetch_array($res11))
			{
...
if($reg11["idcargo"] == $tra33["idcargo3"]){  ?>
	...
	<option selected value= "<?php echo $tra33["idcargo3"];?>"><?php echo $tra33["cargo"]?></option>
...
<?php }  else { ?>
		...
		<?php  } ?>		
					...
					<input align ="right"  name="ingresar" class="btn btn-primary large" onclick="ValidaIngreso()"  type="submit" value = "Actualizar"  title = "Actualizar"/>
					
					<button type="button"  onclick="window.location.href='deleteusuario.php?idusuario=<?php echo $idusuario?>'" class="btn btn-danger">Borrar</button>
...
<script>
	...
	function ValidaIngreso(){
		...
		document.getElementById('form').action = 'edicionsaveusuario.php?idusuario='+idusu;
